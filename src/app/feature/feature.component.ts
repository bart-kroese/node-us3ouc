...
import { ConfigurationFeature, Configuration, FeatureModelRelationshipDisplayType } from '@elfsquad/configurator';
...
export class FeatureComponent implements OnInit {
  ...
  @Input('Bart') Bart: FeatureModelRelationshipDisplayType | undefined
